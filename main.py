...
all_pongs = ping_pong_contract.get_all_pongs(candidate_starting_block, candidate_bot)
...
if len(pings_hash_in_pongs) < len(all_pings):
    ...
    missing_pings = [
        ping.transactionHash for ping in all_pings if not ping in pings_hash_in_pongs
    ]
